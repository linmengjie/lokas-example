cc.Class({
    ...
    addItem: function(node) {
        this.content.height = (this.totalCount + 1) * (node.height + this.spacing) + this.spacing; // get total content height
    ...
    moveBottomItemToTop () {
        let offset = (this.items[0].height + this.spacing) * this.items.length;
